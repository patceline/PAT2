...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [pos,vel,actual_position] = solve_relativistic

global mu mass tol corr year runtime n;
...
% beta = 1.0;
% gamma = 1.0;
% %fileID = fopen([ datestr(clock) '-timesteps.txt'],'w');
% 
...
% % [mu,mass,actual_position,y0,t0,tspan] ...
%  = setup2; 
...
% choose tolerances
Abstol = tol;%1e-4; % 1e-6 by default
Reltol = tol;%1e-4; % 1e-3 by default
